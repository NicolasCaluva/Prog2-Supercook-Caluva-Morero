document.addEventListener('DOMContentLoaded', function () {
    ...
    let graphicTypeButton = document.getElementById('graphic-type');
    graphicTypeButton.addEventListener("change", function (){
        location.reload();
    })
    let graphicType = graphicTypeButton.checked ? 'pie' : 'bar';
